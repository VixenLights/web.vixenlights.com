...
From the main admin window, select **Tools -> Import Sequence Package** from the menu. A wizard workflow will walk you through importing the sequence(s) from the package.
