...
The **Set Level** is the most basic of all effects. It allows you to turn on an element at a level for the specific duration. The level slider determines the brightness of the effect. It supports a single RGB color.
