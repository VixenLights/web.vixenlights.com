...
* **Group Level** Controls how many elements in the group have the same flicker applied to them. Defaults to 1 meaning each element gets its own unique flicker.
