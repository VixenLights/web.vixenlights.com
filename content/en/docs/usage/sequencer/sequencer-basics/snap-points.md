...
Effects support snapping to each other. When dragging or resizing an Effect, when it gets close to another Effect it will jump to or attract to the other Effect. This enables you to easily get two effects back to back without trying to align them precisely. Effects favor being glued to another Effect.
