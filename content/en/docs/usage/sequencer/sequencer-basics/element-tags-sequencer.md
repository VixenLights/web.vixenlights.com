...
![Tags context menu on the Sequencer row labels](/images/docs/usage/sequencer/sequencer-basics/element-tags-sequencer/Sequencer-Tags-Context.png "Tags context menu")
...
![Colored tag dots next to element row labels](/images/docs/usage/sequencer/sequencer-basics/element-tags-sequencer/Sequencer-Color-Dots.png "Tag color dots")
...
![Deprecated Elements warning dialog shown when a sequence loads with effects on deprecated elements](/images/docs/usage/sequencer/sequencer-basics/element-tags-sequencer/Deprecated-Warning.png "Deprecated Elements warning")
...
![Manage Tag Colors dialog](/images/docs/usage/sequencer/sequencer-basics/element-tags-sequencer/Element-Tag-Manager.png "Element Tag Manager")
