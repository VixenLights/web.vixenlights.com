...
Layers are combined from the highest to the lowest by definable mixers. Each layer you create can have its own mixer chosen from the available mixers. Each mixer defines how colors will combine between layers.
