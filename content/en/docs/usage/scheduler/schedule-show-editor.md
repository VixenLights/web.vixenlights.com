...
* **Startup** - This tab controls which items will occur once at the start of a show.
* **Background** - This controls items that will run constantly in the background during the entire show. This is useful for things like a tune to sing.
