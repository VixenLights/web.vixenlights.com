...
There are multiple ways to rename elements. The simplest form is a single item rename. There are also features that enable multiple items to be renamed at the same time. One of them will be discussed here. The other one has its own section under [Find/Replace]({{< ref renaming-elements-find-replace.md>}}).
