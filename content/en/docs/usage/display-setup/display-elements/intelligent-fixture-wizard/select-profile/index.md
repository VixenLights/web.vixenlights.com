...
* **Revision** - Field for keeping track of updates to the profile definition.  Refer to Persistence Note below for implications of updating a profile.
...
If the Profile Name is changed it is effectively a 'Save As' like operation as the existing profile is not modified.
