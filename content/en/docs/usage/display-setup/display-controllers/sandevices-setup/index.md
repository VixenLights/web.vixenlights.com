...
![Controller Output Count](controller-output-count.png)
...
![SACN Controller Setup](sacn-controller-setup.png)
...
![Destination Address](sacn-ip-address.png)
...
![Generic Numbered Group](generic-numbered-group.png)
...
![Elements Selected](elements-selected.png)
...
![Patch Elements](patch-elements.png)
