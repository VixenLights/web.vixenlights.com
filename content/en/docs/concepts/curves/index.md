...
Once you are happy with a custom curve, you can save it to the library and link it to other effects so they can look the same. The curve library can be edited from within the effect editor or from the Tools menu in the main sequencer window.
...
![Curve Library Dialog](CurveLibraryDialog-300x251.png)

![Curve Library Docker](CurveLibraryDocker-154x300.png)

![Curve Library Toolbar](CurveLibraryToolbar-300x50.png)
