...
![Execution Flow](v3-execution-flow-1.png)
...
2. If there are multiple data objects destined for a single output, they need to be reduced to just one. This is called *Combination*.
...
![Execution Flow](v3-execution-flow-2.png)
...
![Execution Flow](v3-execution-flow-3.png)
